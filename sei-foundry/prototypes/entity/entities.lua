...
data:extend({
    {
        ...
        sound_accents =
        {
            ...
            {sound = {variations = path_util.sa_soundvariations("sound/entity/foundry/foundry-fire-whoosh", 3, 0.8), audible_distance_modifier = 0.3}, frame = 64},
            ...
            {sound = {variations = path_util.sa_soundvariations("sound/entity/foundry/foundry-pour", 2, 0.7)}, frame = 110},
